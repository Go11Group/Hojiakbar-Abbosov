		...
		case 1:
			...
			for sikl2 {
				...
				case 2:
					...
					fmt.Println("0->Exit\t1-Company\t2-Vakansiya\t3-Interviyu\t4->Vakansiya Qo'shish")
					var tanlov3 int
					fmt.Scan(&tanlov3)
					switch tanlov3 {
					case 0:
						...
						case 1:
							...
							for sikl6 {
								...
								case 1:
									...
									for sikl7 {
										...
										case 3:
											...
											a:=methodInterview.DeleteInterview(RecuiterId,CompanyId,VacansyId,ineterviewid)
											if a==true{
										...
										case 4:
											...
											a := methodInterview.UpdateInterview(RecuiterId,CompanyId,VacansyId,interviewId2,inter)
											if a==true{
								...
								case 2:
									...
									a:=methodVacansi.CreateVacansy(RecuiterId,CompanyId,v)
									if a==true{
										fmt.Println("Success")
									}else{
										fmt.Println("Failed")
								...
								case 3:
									...
									fmt.Scan(&vakansy)
									a := methodVacansi.DeleteVacansy(RecuiterId,CompanyId,vakansy)
									if a==true{
										fmt.Println("Success")
									}else{
										fmt.Println("failed")
								...
								case 4:
									...
									a := methodVacansi.UpdateVancy(RecuiterId, CompanyId,vakansyId,vac)
									if a==true{
										fmt.Println("Success")
									}else{
										fmt.Println("Failed")
