...
type WeatherServiceClient interface {
	...
	ReportWeatherCondition(ctx context.Context, in *WeatherConditionReport, opts ...grpc.CallOption) (*WeatherConditionResponse, error)
}
...
func (c *weatherServiceClient) ReportWeatherCondition(ctx context.Context, in *WeatherConditionReport, opts ...grpc.CallOption) (*WeatherConditionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type WeatherServiceServer interface {
	...
	ReportWeatherCondition(context.Context, *WeatherConditionReport) (*WeatherConditionResponse, error)
...
func (UnimplementedWeatherServiceServer) ReportWeatherCondition(context.Context, *WeatherConditionReport) (*WeatherConditionResponse, error) {
...
func _WeatherService_ReportWeatherCondition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WeatherServiceServer).ReportWeatherCondition(ctx, req.(*WeatherConditionReport))
	}
	return interceptor(ctx, in, info, handler)
}
