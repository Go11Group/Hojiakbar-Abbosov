...
func (recuiter *Recruiter) CreateInterview(recuiterid5, companyId5, vacancyId5 int, interview1 Interview) {
	reuciters := []Recruiter{}
...
func (recuiter *Recruiter) UpdateInterview(recuiterId6, companyId6, vacancyId6, inetrviewId6 int, interview1 Interview) {
	reuciters := []Recruiter{}
	companyFile, err := os.OpenFile("manager.json", os.O_CREATE|os.O_RDWR|os.O_APPEND, 0666)
	if err != nil {
		fmt.Println("File is not ")
...
func (recuiter *Recruiter) DeleteInterview(recuiterid8, companyid8, vacansyid8, interviewid8 int) {
	reuciters := []Recruiter{}
